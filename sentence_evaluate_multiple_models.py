...
def get_args():
    ...
    parser.add_argument("--model_names", type=str, default="sentence-bert-contrastive-phobert-base-segments-round-1,sentence-bert-contrastive-condenser-phobert-base-segments-round-1,sentence-bert-contrastive-phobert-large-segments-round-1,sentence-bert-contrastive-vibert-base-cased-segments-round-1")
    ...
    parser.add_argument("--weights", type=str, default="0.35,0.35,0.2,0.1")
