...
def get_args():
    ...
    parser.add_argument("--encoded_data_dir", type=str, default=r"F:\Programming\PythonProjects\Natural_Language_Processing\embeddings\colbert_segments_round_1")
    parser.add_argument("--model_name", type=str, default="phobert_base_colbert_tevatron_round_1")
...
if __name__ == "__main__":
    ...
    for idx, item in tqdm(enumerate(items)):
        ...
        scores = np.einsum("in,pjn->ipj", quest_emb, emb_legal_data)
